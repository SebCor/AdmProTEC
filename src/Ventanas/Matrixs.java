 ...
 * @author fredy_000
 */
public class Matrixs extends javax.swing.JFrame {
    ...
    Graph arbol;
    Frame frame;
    public Matrixs(int i,Graph arboles,int matriz,Frame frame ) {
        this.i=i;
        this.arbol=arboles;
        this.frame = frame;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Matrixs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
