...
public void R_repaint(){
        for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                ...
                ColorGUI.pintarLinea(MainWindow.jPanel1.getGraphics(),arboles.getCordeX(j),arboles.getCordeY(j), arboles.getCordeX(k), arboles.getCordeY(k),arboles.getmCoeficiente(j, k));
            }
        }
        for (int j = 0; j < i; j++) {
            ColorGUI.pintarCirculo(MainWindow.jPanel1.getGraphics(), arboles.getCordeX(j),arboles.getCordeY(j),String.valueOf(arboles.getNombre(j)));
 ...
 ColorGUI pintar ;
      Graph arboles ;
      Frame frame;
    public DeleteEdge(ColorGUI pinta , Graph arbole ,int ii, Frame fram) {
        initComponents();
        i=ii;
        this.pintar =pinta;
       this.arboles=arbole;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Error.. Faltan datos : ");
            ...
            JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
                ...
                n1.setText(null);
                n2.setText(null);
                MainWindow.jPanel1.paint(MainWindow.jPanel1.getGraphics());
