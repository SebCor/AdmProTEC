 ...
 * @author fredy_000
 */
public class EdgeWindow extends javax.swing.JFrame {
     ...
     */  
      ...
      Graph arboles ;
      Frame frame1;
    public EdgeWindow(Graph arbole,ColorGUI pinta ,int I,Frame frame){
       this.pintar =pinta;
       this.arboles=arbole;
       this.i=I;
       frame1 = frame;
         ...
         if(x==y)
           JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
            ...
            JOptionPane.showMessageDialog(null,"Error.. Nodos No validos "); 
             ...
             n2.setText(null);
             tm.setText(null);
            ColorGUI.pintarLinea(MainWindow.jPanel1.getGraphics(),arboles.getCordeX(x), arboles.getCordeY(x), arboles.getCordeX(y), arboles.getCordeY(y), ta);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EdgeWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
